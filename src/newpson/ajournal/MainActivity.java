...
public class MainActivity extends Activity implements View.OnClickListener, View.OnTouchListener, CompoundButton.OnCheckedChangeListener
{
	...
	public boolean onTouch(View v, MotionEvent event)
	{
		...
		switch (event.getAction()) {
			case MotionEvent.ACTION_DOWN:
				surface.move(x, y);
				surface.dragStart(x, y, 1.0f);
				break;
			case MotionEvent.ACTION_MOVE:
				surface.move(x, y);
				surface.drag(x, y, 1.0f);
				break;
			case MotionEvent.ACTION_UP:
				surface.move(x, y);
				surface.dragStop(x, y, 1.0f);
				break;
		}
